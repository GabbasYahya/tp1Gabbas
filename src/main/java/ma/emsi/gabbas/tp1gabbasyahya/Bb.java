...
public class Bb implements Serializable {
    ...
    /**
     * Indique si le panneau de debug doit être affiché.
     */
    ...
    /**
     * Contenu JSON de la requête transféré aux services distants.
     */
    private String texteRequeteJson;

    /**
     * Contenu JSON retourné par le service distant.
     */
    ...
    /**
     * Utilitaire pour gérer les requêtes JSON vers l'API Gemini.
     */
    @Inject
    ...
    public String envoyer() {
        ...
        try {
            ...
            // En cas d'erreur de requête, récupérer la requête JSON si disponible
            if (e.getRequeteJson() != null) {
                this.texteRequeteJson = e.getRequeteJson();
            }
    ...
    public List<SelectItem> getRolesSysteme() {
        if (this.listeRolesSysteme == null) {
            ...
            role = """
                    Tu es une entité interstellaire qui transmet la sagesse de civilisations disparues.
                    Tu parles avec un ton solennel, lent et presque musical.
                    Tes réponses sont à la fois spirituelles et rationnelles, comme si tu cherchais à élever
                    la conscience de ton interlocuteur.
                    """;
            this.listeRolesSysteme.add(new SelectItem(role, "Sage interstellaire"));
        }
